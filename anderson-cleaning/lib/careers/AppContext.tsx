...
import { LanguageCode, Theme, Translations, FormDataShape, SparkType, AppContextType, SectionError } from './types'
import { mockTranslations, INITIAL_FORM_DATA, SECTIONS_CONFIG, DEFAULT_LANGUAGE, DEFAULT_THEME } from './constants'
...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const appContextValue: AppContextType = useMemo(() => ({
    ...
    currentSectionIndex, applicationStatus, isLoadingSpark, sparkResults, formErrors
  ])
